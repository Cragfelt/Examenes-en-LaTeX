...
\vspace{-2.5cm}
\item De acuerdo con los datos de la figura, si $F$, $A$ y $M$ son colineales y la medida del $\angle GAF=127\degre$. ¿Cuánto mide el $\angle GAM$?

\parbox{6.5cm}
{\vspace{-2.5cm}
\benu
\item[] \opc $33\degre$ \vf
\item[] \opc $53\degre$ \vf
...
\draw[color=black] (-1.06,-0.1) node {\large $F$};
\draw [fill=black] (3.46,0.3) circle (1.75pt);
\draw[color=black] (3.46,-0.1) node {\large $M$};
\draw [fill=black] (1.18,0.3) circle (1.75pt);
\draw[color=black] (1.12,-0.1) node {\large $A$};
\draw [fill=black] (2.14,2.34) circle (1.75pt);
\draw[color=black] (1.86,2.8) node {\large $G$};
\end{scriptsize}
\end{tikzpicture}
}

\vspace{-2cm}
\item De acuerdo con los datos de la figura, $\angle DOB$ y $\angle EOD$ son 
...
\item El complemento del suplemento de un ángulo de medida $118\degre$, es un ángulo que mide \vp

\benu
\item[] \opc $18\degre$ \vf
\item[] \opc $28\degre$ \vf
...
{\vspace{-1cm}
\benu
\item[] \opc $\stackrel{\longleftrightarrow}{RS}\,\subset\pi$ \vf
\item[] \opc $\stackrel{\longleftrightarrow}{RS}\,\not\subset\pi$ \vf
\item[] \opc $A\subset\,\stackrel{\longleftrightarrow}{RS}$ \vf
\item[] \opc $\stackrel{\longleftrightarrow}{AD}\,\parallel\,\stackrel{\longleftrightarrow}{RS}$
\eenu} 
\parbox{3cm}
...
\draw[color=black] (-1.96,3.1) node {\large $R$};
\draw [fill=black] (3.12,2.56) circle (1.5pt);
\draw[color=black] (3.26,3.1) node {\large $S$};
...
\vspace{-0.3cm}
\item Si $\ell_1\parallel\ell_2$ y además $\ell_2\perp\ell_3$, entonces, con certeza se cumple que \vs
\benu
...
\item La expresión simbólica \,\,$\ell\cap\pi=\{H\}$ significa que la \vp
...
\item[] \opc intersección de la recta $\ell$ y el plano $\pi$ es el punto $H$.
\eenu
\vs

\item La suma de las medidas de dos ángulos rectos genera un ángulo clasificado como \vs
...
\item De acuerdo con los datos de la figura, dos ángulos complementarios son
...
\item De acuerdo con los datos de la figura tridimensional la cual representa un prisma recto de base hexa\-go\-nal, responda lo que se le solicita en el espacio indicado.\vs
...
\draw[color=black] (-0.55,1.1) node {\large $32\textrm{\degre}$};
\end{scriptsize}
\end{tikzpicture}
...
\draw[color=black] (1.55,0.4) node {\large $50\textrm{\degre}$};
\draw[color=black] (-0.71,-1.38) node {\large $29\textrm{\degre}$};
\draw[color=black] (-1.2,0.68) node {\large $63\textrm{\degre}$};
\end{scriptsize}
\end{tikzpicture}
\vs


\item Dos ángulos son complementarios y se sabe que uno mide el doble de la medida del
otro. Encuentre las medidas de los dos ángulos. \hfill{\bf (3 puntos)}

\vs\vs\vs\vs\vs\vs\vs\vs

\item ¿Cuál es el suplemento de un ángulo que es complemento de otro que mide $60\degre$? {\bf (3 puntos)}
\eenu
